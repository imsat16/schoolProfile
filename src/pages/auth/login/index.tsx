...
const Login = () => {
    ...
    const timeLess = cookies.timelessToken
    ...
    const handleLogin = async (e: any) => {
        ...
        AUTH.login({
            ...
            res => {
                ...
                setCookie(null, 'timelessToken', res.data,{
                    maxAge: 24 * 60 * 60,
                    path: '/auth',
                })
            ...
            <div className="flex flex-col items-center w-full px-4 md:w-1/2">
                ...
                >
                    {/* <input 
                        ...
                        placeholder="Email" 
                        value={email}
                        onChange={(e:any)=>setEmail(e.target.vallue)}
                    /> */}
                    <Input
                        placeholder='Email'
                    ...
                    <div className="relative">
                        {/* <input 
                            ...
                            value={password}
                            onChange={(e:any)=>setPassword(e.target.vallue)}
                        /> */}
                        <Input
                            placeholder='•••••••••'
                            type='password'
